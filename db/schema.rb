...
ActiveRecord::Schema[8.0].define(version: 2026_07_22_000002) do
  ...
  create_table "shipstation_orders", force: :cascade do |t|
    ...
    t.index ["company_id", "fluid_order_id"], name: "index_ss_orders_on_company_and_fluid_order_id", unique: true
