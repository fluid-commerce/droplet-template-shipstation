...
variable "startup_script" {
  ...
  type        = string
  default     = " #! /bin/bash\n docker images \"us-west3-docker.pkg.dev/fluid-417204/fluid-droplets/fluid-droplet-shipstation-rails/web\" --format \"{{.ID}}\" | tail -n +2 | xargs -r docker rmi -f"
}
...
variable "container_image" {
  ...
  type        = string
  default     = "us-west3-docker.pkg.dev/fluid-417204/fluid-droplets/fluid-droplet-shipstation-rails/web:latest"
}
